...
import { type Abstract, type Type, type DynamicModule, type ForwardReference, type Provider } from '@nestjs/common';
import { ServeStaticModule } from '@nestjs/serve-static';
import { configModule } from '../../config';
import { HealthModule } from '.';
...
export interface IModuleMetadata {
   ...
   */
    exports: Array<
    DynamicModule | Promise<DynamicModule> | string | symbol | Provider | ForwardReference | Abstract<unknown> | Function // eslint-disable-line @typescript-eslint/ban-types
    >
}
