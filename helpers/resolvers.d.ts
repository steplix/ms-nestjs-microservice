 ...
 */
export declare const resolveEnvVar: (key: string, defaultValue?: any) => any;
/**
 * Resolve environment variable on process. In undefined case, return "defaultValue".
 *
 * Examples,
 ...
 * @return process environment value or default value
 */
export declare const resolveEnvVarWithPrefix: (key: string, prefix?: string, defaultValue?: any) => any;
/**
 * Resolve environment variable on process. In undefined case, return "defaultValue".
 *
 * Examples,
 ...
 * @return process environment value or default value
 */
export declare const resolveEnvVarByApp: (key: string, defaultValue?: any) => any;
/**
 ...
 */
export declare const resolvePossibleFunctionValue: (value: any, defaultValue: any, ...args: any[]) => any;
